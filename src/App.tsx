...
const App: React.FC = (): JSX.Element => {
    ...
    return (
        <main className='flex justify-center items-center bg-sky-500 min-h-screen'>
            <section className='bg-white bg-opacity-20 backdrop-blur-lg drop-shadow-lg rounded flex flex-col text-center items-center p-4 justify-center px-4 md:px-10 w-full max-w-[800px]'>
                {toggleBtn ? (
                    <>
